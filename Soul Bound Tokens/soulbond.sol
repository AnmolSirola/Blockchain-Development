...
contract UniversityDegree is ERC721URIStorage {
    ...
    function issuedDegree(address to) external onlyOwner{
    ...
    function safeTransferFrom(address _from, address _to, uint256 _tokenId) public virtual override {
        require(cannotTransfer == false, "You cannot tranfer this NFT.") ;   
    } 

    function tranferFrom(address _from, address _to, uint256 _tokenId) public virtual override {
